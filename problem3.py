...
# problem 4
print("row counts the " + str(counts[word_index_dict['the'],]))
print("row counts all " + str(counts[word_index_dict['all'],]))
print("row counts anonymous " + str(counts[word_index_dict['anonymous'],]))
